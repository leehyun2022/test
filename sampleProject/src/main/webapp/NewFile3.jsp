...
<td> <select :name="'list['+index+'].eprssAt'"> <option v-for="(epItem,index) in testSet" :selected="epItem.FLAG == item.EPRSS_AT" :value="epItem.FLAG"> {{epItem.VAL}} </option> </select> </td> 
</tr> 
</div> 
</body>
  <script>
